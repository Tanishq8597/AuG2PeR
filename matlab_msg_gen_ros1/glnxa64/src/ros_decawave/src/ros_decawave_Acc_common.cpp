...
// Common copy functions for ros_decawave/Acc
...
namespace Acc {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const ros_decawave::Acc::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  ROS_DECAWAVE_EXPORT void copy_from_arr(boost::shared_ptr<ros_decawave::Acc>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  ROS_DECAWAVE_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const ros_decawave::Acc>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","x","y","z"});
    // header
