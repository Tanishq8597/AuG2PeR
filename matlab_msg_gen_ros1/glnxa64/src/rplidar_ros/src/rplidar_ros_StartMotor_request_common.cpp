...
namespace StartMotor_Request {
  ...
  MDArray_T get_arr_std_msgs_UInt16(MDFactory_T& factory, const rplidar_ros::StartMotor::Request::_pwm_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_std_msgs_UInt16(std_msgs::UInt16& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  RPLIDAR_ROS_EXPORT void copy_from_arr(rplidar_ros::StartMotor::Request& msg, const matlab::data::StructArray arr) {
    try {
        //pwm
  ...
  //----------------------------------------------------------------------------
  RPLIDAR_ROS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const rplidar_ros::StartMotor::Request& msg) {
