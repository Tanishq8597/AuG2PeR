#ifndef _ROS_parkinsons_Gripper_h
#define _ROS_parkinsons_Gripper_h
...
namespace parkinsons
{
  ...
  class Gripper : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "parkinsons/Gripper"; };
    virtual const char * getMD5() override { return "fbda6a1b00fa9ef3ad7d9b4343fcecad"; };
